// Shim de design-sync: copia de components/VehicleCard.tsx con `next/link`
// reemplazado por `<a>` para que el bundle no arrastre el runtime de Next.
// Mismas props y markup que el componente real. Si cambias el real, refleja
// el cambio aquí (ver .design-sync/NOTES.md → Re-sync risks).
